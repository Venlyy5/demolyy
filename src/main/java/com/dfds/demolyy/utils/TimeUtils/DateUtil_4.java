...
public class DateUtil_4 {
    ...
    public static String getCurrentDate() {
        String datestr = null;
        SimpleDateFormat df = new SimpleDateFormat(DateUtil_4.DATE_FORMAT);
    ...
    public static String getCurrentDateTime() {
        String datestr = null;
        SimpleDateFormat df = new SimpleDateFormat(DateUtil_4.DATE_TIME_FORMAT);
        datestr = df.format(new Date());
        return datestr;
    }
    ...
    public static Date stringToDate(String datestr) {
        ...
        try {
            ...
            date = DateUtil_4.stringToDate(datestr, "yyyyMMdd");
        }
        return date;
    }
    ...
    public static Date getLastDayOfMonth(Date date) {
        return DateUtil_4.addDay(DateUtil_4.getFirstDayOfMonth(DateUtil_4.addMonth(date, 1)), -1);
    }
    ...
    public static long getDayByMinusDate(Object fromDate, Object toDate) {
        ...
        Date f = DateUtil_4.chgObject(fromDate);

        Date t = DateUtil_4.chgObject(toDate);
    ...
    public static int calcAge(Date birthday, Date calcDate) {
        ...
        int cYear = DateUtil_4.getYearOfDate(calcDate);
        int cMonth = DateUtil_4.getMonthOfDate(calcDate);
        int cDay = DateUtil_4.getDayOfDate(calcDate);
        int bYear = DateUtil_4.getYearOfDate(birthday);
        int bMonth = DateUtil_4.getMonthOfDate(birthday);
        int bDay = DateUtil_4.getDayOfDate(birthday);
    ...
    public static String getBirthDayFromIDCard(String idno) {
        ...
        return DateUtil_4.dateToString(cd.getTime());
    }
    ...
    public static Date chgObject(Object date) {
        ...
        if (date != null && date instanceof String) {
            return DateUtil_4.stringToDate((String) date);
        }
        return null;
    ...
    public static void main(String[] args) {
        ...
        long s = DateUtil_4.getDayByMinusDate("2012-01-01", "2012-12-31");
