...
//    }
     ...
     * @return
     */
    public static byte[] encodeBarcode(String contents) {
//        int width = 105;
//        int height = 50;
        int width = 300;
        int height = 70;
...
//        byte[] bytes = encodeBarcode("S001180808000021-1537942045", 300, 80);
//        //转换为base64
//        String barcodeBase = Base64.getEncoder().encodeToString(bytes);
//        System.out.println(barcodeBase);
//    }
